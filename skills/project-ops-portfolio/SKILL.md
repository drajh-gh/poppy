---
name: project-ops-portfolio
description: Prepare a cross-project portfolio review from sanitized Project Operations summaries. Use for comparing project health, milestones, capacity, budget/commercial exposure, risks, decisions, stakeholder attention, delivery confidence, or prioritization across multiple isolated client/project vaults.
---
...
3. Separate confirmed facts, project-derived assessments, and portfolio inference.
4. Rank attention by consequence, urgency, dependency, and recoverability.
